...
### 5. ⚙️ Продвинутые сетевые параметры
...
* **Ручная проверка в настройках:** Раздел настроек дополнен информацией о текущей версии и кнопкой принудительного поиска обновлений.
